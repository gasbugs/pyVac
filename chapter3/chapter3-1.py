...
hdb = [
    '44d88612fea8a8f36de82e1278abb02f:68:Win.Test.EICAR_HDB-1',
    'c27e671b012030efdacfce86e9795e96:143360:Win.Spyware.Bispy-7'
]

for vdb in hdb :
    fileNameList.append(vdb.split(':')[2])
    fileSizeList.append(int(vdb.split(':')[1]))
    fileHashList.append(vdb.split(':')[0])
